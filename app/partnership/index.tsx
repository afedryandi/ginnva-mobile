  ...
  if (phase === 'success') {
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        <ScreenHeader title="Ajukan Kemitraan" />
        <View style={styles.centerState}>
          ...
          <Text style={styles.successNote}>
            Terima kasih atas minat Anda menjadi mitra Ginnva Shield Indonesia.
      ...
      >
        ...
        <View style={styles.noticeBox}>
          ...
          <Text style={styles.noticeText}>
            Bergabunglah sebagai dealer atau mitra resmi Ginnva Shield Indonesia.
        ...
        <Card style={styles.formCard}>
          ...
          {/* Email */}
          <Text style={[styles.fieldLabel, { marginTop: spacing.md }]}>
            Email <Text style={styles.optional}>(opsional)</Text>
          </Text>
          <TextInput
            style={styles.input}
